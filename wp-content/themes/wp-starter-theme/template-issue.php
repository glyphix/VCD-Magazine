	...
	<div class="page-content clearfix">
		...
		<section id="letter">
			...
			<article id="post-wrap" <?php post_class(); ?>>
				<!-- post title -->
				<a href="<?php the_permalink(); ?>">
					<h3 class="post-type color-1"><?php $post_type = get_post_type_object( get_post_type($post) );
		...
		if ( $pop->have_posts() ) : ?>
			...
			<h3 class="post-type color-1">Points of Pride</h3>				
				<ol class="slider">					
					...
					<li class="slide border-color-1" id="post-wrap" <?php post_class(); ?>>
		...
		<?php
		$args = array(
			'post_type' => array( 'story', 'interview'),
			'category__not_in' => array( 12, 5 ),
			'meta_query' => array(
				array(
					'value' => "$issue_number",
